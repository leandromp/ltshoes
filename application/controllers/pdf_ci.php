...
class Pdf_ci extends CI_Controller 
{
    ...
    {
        if(!is_dir(BASE_SITIO."archivos/"))
        {
            mkdir(BASE_SITIO."archivos/", 0777);
            mkdir(BASE_SITIO."archivos/pdfs/", 0777);
        }
    }
    ...
    public function index()
    {
        ...
        $this->html2pdf->folder(BASE_SITIO.'archivos/');
        ...
        $data = array(
            ...
            'productos' => $this->producto->getOutlet()
        );
        
        //hacemos que coja la vista como datos a imprimir
        //importante utf8_decode para mostrar bien las tildes, ñ y demás
        $this->html2pdf->html(utf8_decode($this->load->view('productos/lista_outlet', $data, true)));
